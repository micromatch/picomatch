...
describe('picomatch', function() {
  ...
  describe('isMatch:', function() {
    ...
    it('should match paths with leading `./`', function() {
      const opts = { prefix: '(?:\\.\\/)?' };
      const isMatch = (str, pat) => pm.isMatch(str, pat, opts);
      assert(!isMatch('./.a', '*.a'));
      assert(!isMatch('./.a', './*.a'));
      assert(!isMatch('./.a', 'a/**/z/*.md'));
      ...
      assert(isMatch('./a/b/c/d/e/z/c.md', '**/*.md'));
  ...
  describe('qmarks and stars', function() {
    it('should correctly handle question marks in globs', function() {
      ...
      assert.deepEqual(pm(['x/y/acb', 'acb', 'acb/', 'acb/d/e'], 'a?b', { suffix }), ['acb', 'acb/']);
  ...
  //     const f = fixtures.slice().concat('baz', 'bzz', 'BZZ', 'beware', 'BewAre');
  ...
  //   it('should support globstars (**)', function() {
  //     const fixtures = ['../../b', '../a', '../c', '../c/d', '.a/a', '/a', '/a/', 'a', 'a/', 'a/../a', 'a/.a', 'a/a', 'a/b', 'a/c', 'a/x', 'a/x/y', 'a/x/y/z', 'aa/a', 'aaa/a', 'aab/a', 'ab/../ac'];
  ...
  //     const fixtures = ['.gitignore', 'a/b/z/.dotfile', 'a/b/z/.dotfile.js', 'a/b/z/.dotfile.txt', 'a/b/z/.dotfile.md'];
  ...
  //     const re = pm.makeRe('node_modules/foobar/**/*.bar');
