...
// bench('.makeRe star (caching disabled)')
...
// bench('.isMatch no-glob (caching disabled)')
...
// bench('.makeRe with star (caching disabled)')
...
// bench('.makeRe - globstar (caching disabled)')
...
// bench('.makeRe - globstar_negated (caching disabled)')
//   // .add('micromatch', () => micro.isMatch('foo/bar.txt', '!**/bar.txt', miOpts2))
...
// bench('.makeRe - braces (caching disabled)')
