...
const { micro, mini, pico, pico2 } = require('./load-time');
...
//   .add('picomatch (lexer)', () => pico.isMatch('abc.txt', '*'), pOpts)
//   .add('picomatch (parser)', () => pico2.isMatch('abc.txt', '*'), pOpts)
//   .run();

// bench('.isMatch')
//   .add('micromatch', () => micro.isMatch('abc.txt', 'c*3.txt'), miOpts)
//   .add('minimatch', () => mini('abc.txt', 'c*3.txt'))
//   .add('picomatch (lexer)', () => pico.isMatch('abc.txt', 'c*3.txt'), pOpts)
//   .add('picomatch (parser)', () => pico2.isMatch('abc.txt', 'c*3.txt'), pOpts)
//   .run();
...
//   .add('picomatch (lexer)', () => pico.isMatch('foo/bar.txt', '**/bar.txt'), pOpts)
//   .add('picomatch (parser)', () => pico2.isMatch('foo/bar.txt', '**/bar.txt'), pOpts)
//   .run();
...
//   .add('picomatch (lexer)', () => pico.isMatch('abc.txt', '{a,b,c}*.txt'), pOpts)
//   .add('picomatch (parser)', () => pico2.isMatch('abc.txt', '{a,b,c}*.txt'), pOpts)
//   .run();

// bench('.match - long_list')
//   .add('micromatch', () => micro.match(longList, '**/*c09.*', miOpts))
//   .add('minimatch', () => mini.match(longList, '**/*c09.*'))
//   .add('picomatch (lexer)', () => pico.match(longList, '**/*c09.*', pOpts))
//   .add('picomatch (parser)', () => pico2.match(longList, '**/*c09.*', pOpts))
//   .run();

// bench('.match - long_list_multiple_globstars')
//   .add('micromatch', () => micro.match(longList, '**', miOpts))
//   .add('minimatch', () => mini.match(longList, '**'))
//   .add('picomatch (lexer)', () => pico.match(longList, 'a/**/*c09.txt', pOpts))
//   .add('picomatch (parser)', () => pico2.match(longList, 'a/**/*c09.txt', pOpts))
//   .run();
...
//   .add('picomatch (lexer)', () => pico.match(longList, '**', pOpts))
//   .add('picomatch (parser)', () => pico2.match(longList, '**', pOpts))
//   .run();

bench('.isMatch (caching disabled)')
  .add('micromatch', () => micro.isMatch('abc.txt', 'c*3.txt', miOpts2))
  .add('minimatch', () => mini('abc.txt', 'c*3.txt'))
  .add('picomatch (lexer)', () => pico.isMatch('abc.txt', 'c*3.txt', pOpts2))
  .add('picomatch (parser)', () => pico2.isMatch('abc.txt', 'c*3.txt', pOpts2))
  .run();

bench('.isMatch star (caching disabled)')
  .add('micromatch', () => micro.isMatch('abc.txt', '*', miOpts2))
  .add('minimatch', () => mini('abc.txt', '*'))
  .add('picomatch (lexer)', () => pico.isMatch('abc.txt', '*', pOpts2))
  .add('picomatch (parser)', () => pico2.isMatch('abc.txt', '*', pOpts2))
  .run();
...
bench('.isMatch - globstar (caching disabled)')
  ...
  .add('minimatch', () => mini('foo/bar.txt', '**/bar.txt'))
  .add('picomatch (lexer)', () => pico.isMatch('foo/bar.txt', '**/bar.txt', pOpts2))
  .add('picomatch (parser)', () => pico2.isMatch('foo/bar.txt', '**/bar.txt', pOpts2))
  .run();
...
bench('.isMatch - braces (caching disabled)')
  ...
  .add('minimatch', () => mini('abc.txt', '{a,b,c}*.txt'))
  .add('picomatch (lexer)', () => pico.isMatch('abc.txt', '{a,b,c}*.txt', pOpts2))
  .add('picomatch (parser)', () => pico2.isMatch('abc.txt', '{a,b,c}*.txt', pOpts2))
  .run();

bench('.match - long_list (caching disabled)')
  .add('micromatch', () => micro.match(longList, '**/*c09.*', miOpts2))
  .add('minimatch', () => mini.match(longList, '**/*c09.*'))
  .add('picomatch (lexer)', () => pico.match(longList, '**/*c09.*', pOpts2))
  .add('picomatch (parser)', () => pico2.match(longList, '**/*c09.*', pOpts2))
  .run();
...
bench('.match - long_list_globstars_and_stars (caching disabled)')
  ...
  .add('picomatch (lexer)', () => pico.match(longList, 'a/**/*c09.txt', pOpts2))
  .add('picomatch (parser)', () => pico2.match(longList, 'a/**/*c09.txt', pOpts2))
  .run();

bench('.match - long_list_multiple_globstars (caching disabled)')
  .add('micromatch', () => micro.match(longList, 'a/**/f/**/*c09.*', miOpts2))
  .add('minimatch', () => mini.match(longList, 'a/**/f/**/*c09.*'))
  .add('picomatch (lexer)', () => pico.match(longList, 'a/**/f/**/*c09.*', pOpts2))
  .add('picomatch (parser)', () => pico2.match(longList, 'a/**/f/**/*c09.*', pOpts2))
  .run();

bench('.match - long_list_single_globstars (caching disabled)')
  .add('micromatch', () => micro.match(longList, '**', miOpts2))
  .add('minimatch', () => mini.match(longList, '**'))
  .add('picomatch (lexer)', () => pico.match(longList, '**', pOpts2))
  .add('picomatch (parser)', () => pico2.match(longList, '**', pOpts2))
  .run();
