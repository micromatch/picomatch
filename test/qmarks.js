...
describe('qmarks and stars', () => {
  ...
  it('should support consecutive stars and question marks', () => {
    assert.deepStrictEqual(match(['aaa', 'aac', 'abc'], 'a*?c'), [
      'aac',
      'abc'
    ]);
    assert.deepStrictEqual(match(['abc', 'abb', 'acc'], 'a**?c'), [
      'abc',
      'acc'
    ]);
    assert.deepStrictEqual(match(['abc', 'aaaabbbbbbccccc'], 'a*****?c'), [
      'abc',
      'aaaabbbbbbccccc'
    ]);
    assert.deepStrictEqual(match(['a', 'ab', 'abc', 'abcd'], '*****?'), [
      'a',
      'ab',
      'abc',
      'abcd'
    ...
    assert.deepStrictEqual(match(['abc', 'bbb', 'zzz'], '?***?****?'), [
      'abc',
      'bbb',
      'zzz'
    ]);
    ...
    assert.deepStrictEqual(match(['abc'], '?***?****'), ['abc']);
    assert.deepStrictEqual(match(['abcdecdhjk'], 'a****c**?**??*****'), [
      'abcdecdhjk'
    ]);
    assert.deepStrictEqual(match(['abcdecdhjk'], 'a**?**cd**?**??***k'), [
      'abcdecdhjk'
    ]);
    assert.deepStrictEqual(match(['abcdecdhjk'], 'a**?**cd**?**??***k**'), [
      'abcdecdhjk'
  ...
  it('should match one character per question mark', () => {
    ...
    assert.deepStrictEqual(match(['a/bbbb/c.md'], 'a/????/c.md'), [
      'a/bbbb/c.md'
    ]);
  });
  ...
  it('should support question marks and stars between slashes', () => {
    assert.deepStrictEqual(match(['a/b.bb/c/d/efgh.ijk/e'], 'a/*/?/**/e'), [
      'a/b.bb/c/d/efgh.ijk/e'
    ]);
    assert.deepStrictEqual(match(['a/b/c/d/e'], 'a/?/c/?/*/e'), []);
    assert.deepStrictEqual(match(['a/b/c/d/e/e'], 'a/?/c/?/*/e'), [
      'a/b/c/d/e/e'
    ]);
    assert.deepStrictEqual(match(['a/b/c/d/efgh.ijk/e'], 'a/*/?/**/e'), [
      'a/b/c/d/efgh.ijk/e'
    ]);
    assert.deepStrictEqual(match(['a/b/c/d/efghijk/e'], 'a/*/?/**/e'), [
      'a/b/c/d/efghijk/e'
    ]);
    assert.deepStrictEqual(match(['a/b/c/d/efghijk/e'], 'a/?/**/e'), [
      'a/b/c/d/efghijk/e'
    ]);
    assert.deepStrictEqual(match(['a/b/c/d/efghijk/e'], 'a/?/c/?/*/e'), [
      'a/b/c/d/efghijk/e'
    ]);
    assert.deepStrictEqual(match(['a/bb/e'], 'a/?/**/e'), []);
    assert.deepStrictEqual(match(['a/bb/e'], 'a/?/e'), []);
    assert.deepStrictEqual(match(['a/bbb/c/d/efgh.ijk/e'], 'a/*/?/**/e'), [
