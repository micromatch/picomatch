...
const parse = (input, options) => {
  ...
  while (!eos()) {
    ...
    if (value === '}') {
      ...
      if (brace.dots === true) {
        const idx = tokens.lastIndexOf(brace);
        const arr = tokens.slice(idx);
        const range = ['', ''];
        let dots = false;
