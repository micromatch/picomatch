...
On some platforms, certain characters that are used for matching in globs and regex may also be used as valid filepath characters. If you wish to match the following characters, they must be escaped with backslashes or quotes:
