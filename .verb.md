...
<p align="center">
  ...
  <a href="https://github.com/{%= repository %}/actions/workflows/test.yml">
    <img src="https://github.com/{%= repository %}/actions/workflows/test.yml/badge.svg?branch=master" alt="test status">
  </a>
...
Picomatch only does [brace expansion][brace-expansion] of comma-delimited lists (e.g. `a/{b,c}/d`). For advanced matching with braces, use [micromatch][], which supports advanced syntax such as ranges (e.g. `{01..03}`) and increments (e.g. `{2..10..2}`).
