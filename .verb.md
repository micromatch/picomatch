...
The fastest, most accurate glob matcher written JavaScript, with no dependencies and full support for standard and extended Bash glob features, including braces, POSIX brackets, and advanced regex features. Picomatch loads faster, runs faster and matches faster than every other matching library, without [sacrificing quality]().
