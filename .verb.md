...
| [onMatch](#optionsonMatch) | `function` | `undefined` | Function to be called on successful matches. |
...
Although this library performs well in benchmarks, and in most cases it's faster than other popular libraries we benchmarked agains, we will always choose accuracy over performance. It's not helpful to anyone if our library is faster at returning the wrong answer.
