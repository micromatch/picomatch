# Contributing to picomatch

First and foremost, thank you! We appreciate that you want to contribute to picomatch, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for picomatch**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for picomatch:

- star the [project](https://github.com/jonschlinkert/picomatch)
- tweet your support for picomatch
...
- **version**: please note the version of picomatch are you using
